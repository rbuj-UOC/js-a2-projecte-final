# Activitat final del nivell A2 de JavaScript

## Exercici 1

- **Enunciat:** [src/ex1.md](src/ex1.md)
- **Codi:** [src/ex1.js](src/ex1.js)

Donada una taula d'ingressos setmanals i un valor, retorna si hi ha alguna setmana amb ingressos superiors al valor donat.
...
- **Enunciat:** [src/ex2.md](src/ex2.md)
- **Codi:** [src/ex2.js](src/ex2.js)

Donada una taula d'objectes amb els ingressos mensuals de cada comercial, retorna el nom del comercial que més ha facturat durant l'any.
